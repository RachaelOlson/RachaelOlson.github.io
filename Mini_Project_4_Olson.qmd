...
This plot demonstrates that words such as *love* and *time* are her most frequently used words despite commonly used words such as I and my. This demonstrates emotional connection in her words as these two words suggest that her words are rooted in both affection adn reflection.


# Second Plot: Positive and Negatively Related Words in Taylor Swift Songs
```{r}
#| message: FALSE
#| warning: FALSE

afinn_sentiments <- get_sentiments(lexicon = "afinn") #score from -5 to +5
